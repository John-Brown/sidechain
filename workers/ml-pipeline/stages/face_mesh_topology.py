...
"""MediaPipe face mesh topology constants (vendored)."""
...
FACEMESH_TESSELATION = frozenset([
    ...
    (259, 260), (260, 444), (444, 259), (260, 467), (467, 445), (445, 260),
    (309, 459), (459, 250), (250, 309), (305, 289), (289, 290), (290, 305),
    (305, 290), (290, 460), (460, 305), (401, 376), (376, 435), (435, 401),
    (309, 250), (250, 392), (392, 309), (376, 411), (411, 433), (433, 376),
    (453, 341), (341, 464), (464, 453), (357, 453), (453, 465), (465, 357),
    (343, 357), (357, 412), (412, 343), (437, 343), (343, 399), (399, 437),
    (344, 360), (360, 440), (440, 344), (420, 437), (437, 456), (456, 420),
    (360, 420), (420, 363), (363, 360), (361, 401), (401, 288), (288, 361),
    (265, 372), (372, 353), (353, 265), (390, 339), (339, 249), (249, 390),
    (339, 448), (448, 255), (255, 339),
])


def get_mesh_topology() -> dict:
    """Return tessellation, contour, and iris connections as sorted pair lists."""
    def _sort(connections: frozenset) -> list:
        return sorted([sorted(list(c)) for c in connections])

    return {
        "tessellation": _sort(FACEMESH_TESSELATION),
        "contours": _sort(FACEMESH_CONTOURS),
        "irises": _sort(FACEMESH_IRISES),
    }
